...
execute if score #armor _var matches 1 run function ult:event/townsquare/upgrade_armor/boots
execute if score #armor _var matches 2 run function ult:event/townsquare/upgrade_armor/helmet
execute if score #armor _var matches 3 run function ult:event/townsquare/upgrade_armor/leggings
execute if score #armor _var matches 4 run function ult:event/townsquare/upgrade_armor/chestplate
