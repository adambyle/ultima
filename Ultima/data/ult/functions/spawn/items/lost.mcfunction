...
execute if score #server map matches 1 run function ult:spawn/items/lost/manor
execute if score #server map matches 2 run function ult:spawn/items/lost/woodlands
execute if score #server map matches 3 run function ult:spawn/items/lost/dungeon
...
execute if score #server map matches 12 run function ult:spawn/items/lost/frontier
execute if score #server map matches 13 run function ult:spawn/items/lost/reflection
execute if score #server map matches 14 run function ult:spawn/items/lost/dracula
