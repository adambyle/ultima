...
execute if score #server map matches 1 run function ult:spawn/items/refills/manor
execute if score #server map matches 2 run function ult:spawn/items/refills/woodlands
execute if score #server map matches 3 run function ult:spawn/items/refills/dungeon
...
execute if score #server map matches 12 run function ult:spawn/items/refills/frontier
execute if score #server map matches 13 run function ult:spawn/items/refills/reflection
execute if score #server map matches 14 run function ult:spawn/items/refills/dracula
