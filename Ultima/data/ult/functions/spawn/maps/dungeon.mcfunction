...
execute store result score .hotbar var run data get storage ult:temp Player.Hotbar.dungeon.axe
loot replace block 0 0 0 container.0 loot ult:map_items/dungeon/axe
function ult:items/give

execute store result score .hotbar var run data get storage ult:temp Player.Hotbar.dungeon.shield
...
function ult:items/refills/dungeon
