...
execute as @s[tag=!ready] run tellraw @s[tag=chat.n.e] [{"text": "N: ", "color": "dark_gray"}, {"selector": "@s", "color": "white"}, {"text": " has voted.", "color": "#577590"}, " ", {"text": "Misclick? Click to change your vote.", "color": "#F9C74F", "underlined": true, "clickEvent": {"action": "run_command", "value": "/trigger action set 5"}}]
