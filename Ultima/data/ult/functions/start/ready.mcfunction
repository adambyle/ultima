...
tellraw @s [{"selector": "@s", "color": "blue"},{"text": " is ready. "}, {"score": {"name": "#ready", "objective": "_var"}, "color": "dark_gray", "underlined": true, "hoverEvent": {"action": "show_text", "contents": ["", {"text": "Ready:\n", "color": "blue", "bold": true}, {"storage": "ult:temp", "nbt": "Ready", "interpret": true, "color": "white"}, {"text": "\nWaiting on:\n", "color": "dark_red", "bold": true}, {"storage": "ult:temp", "nbt": "NotReady", "color": "gray", "interpret": true}]}, "extra": [" / ", {"score": {"name": "#max", "objective": "_var"}}]}, " ", {"text": "Mistake? Click to unready.", "color": "aqua", "underlined": true, "clickEvent": {"action": "run_command", "value": "/trigger action set 7"}}]
tag @s remove root
