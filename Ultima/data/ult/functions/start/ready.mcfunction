...
# Ready up
    ...
    tellraw @a[tag=!root] [{"text": "N: ", "color": "dark_gray"}, {"selector": "@s", "color": "white"}, {"text": " is ready.", "color": "#577590"}]
    tellraw @s [{"text": "N: ", "color": "dark_gray"}, {"selector": "@s", "color": "white"}, {"text": " is ready. ", "color": "#577590"}, {"text": "Mistake? Click to unready.", "color": "#F9C74F", "underlined": true, "clickEvent": {"action": "run_command", "value": "/trigger action set 4"}}]
...
# Test if the game can't start in these conditions
    ...
    execute if score .game_mode flag = flag.game_mode.duels const if score .map_mode flag = flag.map_mode.vote const run tellraw @s [{"text": "N: ", "color": "dark_gray"}, {"text": "You can't play Vote Map in Duels mode.", "color": "#F8961E"}]
    ...
    # Warn if invalid
    execute if score .temp _var matches 0 run tellraw @a [{"text": "N: ", "color": "dark_gray"}, {"text": "You need more players opted in to play this mode.", "color": "#F8961E"}]
