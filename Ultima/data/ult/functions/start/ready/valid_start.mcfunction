...
execute if score .valid _var matches 1 unless score .starting_soon control matches 1 if entity @a[tag=player, tag=!ready] run tellraw @a[tag=chat.n.e] [{"text": "N: ", "color": "dark_gray"}, {"text": "Enough players are ready! The game starts soon.", "color": "#577590"}]
