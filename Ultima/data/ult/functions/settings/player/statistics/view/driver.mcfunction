...
# Test for missing items
    scoreboard players set .icons var 5
    function ult:data/player/get
    execute unless data storage ult:temp Player.StatMenu{map: -1} run scoreboard players remove .icons var 1
    execute if data storage ult:temp Player.StatMenu{mode: 2b} run scoreboard players remove .icons var 1
    execute if data storage ult:temp Player.StatMenu{mode: 3b} run scoreboard players remove .icons var 1
    execute if data storage ult:temp Player.StatMenu{mode: 4b} run scoreboard players remove .icons var 1
    ...
    execute if score @s menu = menu.statistics_display const if score .icons var matches 4.. unless data entity @s EnderItems[{Slot: 16b}] run function ult:settings/player/statistics/view/mode
    execute if score @s menu = menu.statistics_display const if score .icons var matches 5.. unless data entity @s EnderItems[{Slot: 17b}] run function ult:settings/player/statistics/view/mode
