...
# Display icons
    item replace entity @s enderchest.9 with structure_void{GUI: true, display: {Name: '{"text": "Save and Exit", "color": "#43AA8B", "bold": true, "italic": false}'}}
...
# Mark choices
    execute if data storage ult:temp Player.Spectate{joinWorld: true} run item replace entity @s enderchest.11 with blue_terracotta{GUI: true, display: {Lore: ['{"text": "Click to go to lobby on this trigger", "color": "gray"}'], Name: '{"text": "Spectate", "bold": true, "italic": false, "color": "#577590"}'}}
    execute if data storage ult:temp Player.Spectate{death: true} run item replace entity @s enderchest.13 with blue_terracotta{GUI: true, display: {Lore: ['{"text": "Click to go to lobby on this trigger", "color": "gray"}'], Name: '{"text": "Spectate", "bold": true, "italic": false, "color": "#577590"}'}}
    execute if data storage ult:temp Player.Spectate{optOut: true} run item replace entity @s enderchest.15 with blue_terracotta{GUI: true, display: {Lore: ['{"text": "Click to go to lobby on this trigger", "color": "gray"}'], Name: '{"text": "Spectate", "bold": true, "italic": false, "color": "#577590"}'}}
    execute if data storage ult:temp Player.Spectate{startGame: true} run item replace entity @s enderchest.17 with blue_terracotta{GUI: true, display: {Lore: ['{"text": "Click to go to lobby on this trigger", "color": "gray"}'], Name: '{"text": "Spectate", "bold": true, "italic": false, "color": "#577590"}'}}
