# Test for selection
    scoreboard players set .selected var 0
    execute unless data entity @s EnderItems[{Slot: 11b}] run scoreboard players set .selected var 1
    execute unless data entity @s EnderItems[{Slot: 13b}] run scoreboard players set .selected var 2
    execute unless data entity @s EnderItems[{Slot: 15b}] run scoreboard players set .selected var 3
    execute unless data entity @s EnderItems[{Slot: 17b}] run scoreboard players set .selected var 4
    execute if score .selected var matches 1.. run function ult:settings/player/spectate/change
    # Missing icons
