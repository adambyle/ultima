...
# Ready up (or announce vote change)
    ...
    execute if score .vote var matches -2147483648..2147483647 run tellraw @a[tag=chat.n.e, tag=!root] [{"text": "N: ", "color": "dark_gray"}, {"selector": "@s", "color": "white"}, {"text": " changed "}, {"storage": "ult:temp", "nbt": "Possessive"}, {"text": " vote.", "color": "gray"}]
