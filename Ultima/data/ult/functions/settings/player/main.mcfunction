...
# Display icons
    ...
    item replace entity @s enderchest.19 with golden_apple{GUI: true, display: {Name: '{"text": "Hotbar Settings", "color": "#F9C74F", "bold": true, "italic": false}'}, HideFlags: 63}
    ...
    item replace entity @s enderchest.21 with ender_eye{GUI: true, display: {Lore: ['{"text": "Control when the game makes you a spectator.", "color": "gray"}'], Name: '{"text": "Spectator Settings", "bold": true, "color": "#43AA8B", "italic": false}'}}
    # Book: statistics
    item replace entity @s enderchest.23 with book{GUI: true, display: {Name: '{"text": "Statistics", "bold": true, "color": "#7A3200", "italic": false}'}}
    # Command block: chat settings
    item replace entity @s enderchest.25 with command_block{GUI: true, display: {Name: '{"text": "Chat Settings", "italic": false, "bold": true, "color": "#F8961E"}'}}
