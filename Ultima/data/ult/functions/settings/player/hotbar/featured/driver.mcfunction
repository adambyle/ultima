# Check for missing chest items and react accordingly
    ...
    execute if score @s menu = menu.hotbar_featured const if score .selected_map _var >= flag.map.start_featured const if score .selected_map _var <= flag.map.end_featured const run function ult:settings/player/hotbar/workspace
    execute if score @s menu = menu.hotbar_featured const if score .selected_map _var > flag.map.end_featured const run function ult:settings/player/hotbar/featured
