# Check for missing chest items and react accordingly
    ...
    execute if score @s menu = menu.hotbar_default const if score .selected_map var >= flag.map.start_default const if score .selected_map var <= flag.map.end_default const run function ult:settings/player/hotbar/workspace
    execute if score @s menu = menu.hotbar_default const if score .selected_map var > flag.map.end_default const run function ult:settings/player/hotbar/default
