...
execute unless data entity @s EnderItems[{id: "minecraft:golden_apple"}] run scoreboard players set .verify var 0
...
execute if score .verify var matches 1 run function ult:settings/player/hotbar/workspace/assign/woodlands
