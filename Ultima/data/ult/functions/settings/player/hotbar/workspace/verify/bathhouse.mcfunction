...
execute unless data entity @s EnderItems[{id: "minecraft:shears"}] run scoreboard players set .verify _var 0
execute unless data entity @s EnderItems[{id: "minecraft:bow"}] run scoreboard players set .verify _var 0
execute unless data entity @s EnderItems[{id: "minecraft:white_wool"}] run scoreboard players set .verify _var 0
...
execute if score .verify _var matches 1 run function ult:settings/player/hotbar/workspace/assign/bathhouse
