...
execute store success score .temp var run clear @s #ult:map_items/all 0
execute if score .temp var matches 1 store success score .temp var if data entity @s SelectedItem
execute if score .temp var matches 1 run tellraw @s[tag=chat.s.e] [{"text": "S: ", "color": "dark_gray"}, {"text": "Keep the items in the ender chest please!", "color": "#F8961E"}]
execute if score .temp var matches 1 run function ult:settings/player/hotbar/workspace/setup
