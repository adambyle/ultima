execute unless data entity @s EnderItems[{id: "minecraft:stone_axe"}] run scoreboard players set .verify var 0
...
execute unless data entity @s EnderItems[{id: "minecraft:potion", tag: {CustomPotionEffects: [{Id: 1b}]}}] run scoreboard players set .verify var 0
execute unless data entity @s EnderItems[{id: "minecraft:potion", tag: {CustomPotionEffects: [{Id: 3b}]}}] run scoreboard players set .verify var 0
...
execute if score .verify var matches 1 run function ult:settings/player/hotbar/workspace/assign/dungeon
