...
execute if score .game_mode flag = flag.game_mode.brawl const if score #server pn matches 5.. run tellraw @s [{"text": "Opt >> ", "color": "dark_green", "bold": true},{"text": "You will spawn very soon! Just hang on.", "bold": false}]
