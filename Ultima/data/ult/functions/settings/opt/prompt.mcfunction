...
execute if score .temp _var matches 0 run tellraw @s[gamemode=spectator, tag=spectator, tag=chat.n.e] [{"text": "N: ", "color": "dark_gray"}, {"text": "If you need, you can ", "color": "#F9C74F"}, {"text": "click here to go to the lobby.", "underlined": true, "color": "#F9C74F", "clickEvent": {"action": "run_command", "value": "/trigger action set 3"}}]
