# Validate the decision to opt in
    ...
    execute if score .game_state flag = flag.game_state.inactive const run scoreboard players set .temp var 1
    execute if score .game_state flag = flag.game_state.voting const run scoreboard players set .temp var 1
    execute if score .game_state flag = flag.game_state.transition const run scoreboard players set .temp var 1
