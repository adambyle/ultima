...
replaceitem entity @s enderchest.8 diamond_sword{display: {Name: '{"text": "Game Start", "bold": true, "italic": false, "color": "white"}'}, HideFlags: 63}
...
replaceitem entity @s enderchest.17 gray_stained_glass_pane{display: {Name: '{"text": "Disabled", "bold": true, "italic": false, "color": "gray"}', Lore: ['{"text": "Click to enable", "color": "gray"}']}}
replaceitem entity @s enderchest.26 gray_stained_glass_pane{display: {Name: '{"text": "Disabled", "bold": true, "italic": false, "color": "gray"}', Lore: ['{"text": "Click to enable", "color": "gray"}']}}
...
execute if score @s y.spect_game matches 1 run replaceitem entity @s enderchest.17 blue_stained_glass_pane{display: {Name: '{"text": "Enabled", "bold": true, "italic": false, "color": "blue"}'}}
execute if score @s y.spect_game matches 2 run replaceitem entity @s enderchest.26 blue_stained_glass_pane{display: {Name: '{"text": "Enabled", "bold": true, "italic": false, "color": "blue"}'}}
