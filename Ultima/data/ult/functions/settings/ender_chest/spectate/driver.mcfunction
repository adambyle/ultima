...
execute if score #selected _var matches 7 run scoreboard players set @s y.spect_game 1
execute if score #selected _var matches 8 run scoreboard players set @s y.spect_game 2

execute if score #selected _var matches 1.. run function ult:settings/ender_chest/spectate
