...
execute if score .verify _var matches 1 run function ult:settings/ender_chest/hotbar/assign/reflection

execute if score .verify _var matches 0 run function ult:settings/ender_chest/hotbar/general
execute if score .verify _var matches 1 run function ult:settings/ender_chest/hotbar/main
