...
execute unless data entity @s EnderItems[{Slot:15b}] run item replace entity @s enderchest.15 with gray_stained_glass_pane{display: {Name:'{"text": "Inventory Slot 1", "color": "dark_gray", "italic": false}'}}
execute unless data entity @s EnderItems[{Slot:16b}] run item replace entity @s enderchest.16 with gray_stained_glass_pane{display: {Name:'{"text": "Inventory Slot 2", "color": "dark_gray", "italic": false}'}}
execute unless data entity @s EnderItems[{Slot:17b}] run item replace entity @s enderchest.17 with gray_stained_glass_pane{display: {Name:'{"text": "Inventory Slot 3", "color": "dark_gray", "italic": false}'}}
...
execute store result score .temp _var run clear @s #ult:map_items/all 0
...
execute if score .temp _var matches 1 run function ult:settings/ender_chest/hotbar/main
