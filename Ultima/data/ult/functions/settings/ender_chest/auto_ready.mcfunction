...
# Play a sound effect
    execute if score .auto_ready _var matches 0 at @s run playsound entity.player.attack.weak master @s
    execute if score .auto_ready _var matches 1 at @s run playsound entity.player.attack.strong master @s
    execute if score .auto_ready _var matches 2 at @s run playsound entity.player.attack.crit master @s
