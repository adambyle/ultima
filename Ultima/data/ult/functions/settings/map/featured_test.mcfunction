execute unless data block 43 31 -12 Items[{Slot:26b}] run scoreboard players set #selected map 24
execute unless data block 43 31 -12 Items[{Slot:25b}] run scoreboard players set #selected map 23
execute unless data block 43 31 -12 Items[{Slot:24b}] run scoreboard players set #selected map 22
execute unless data block 43 31 -12 Items[{Slot:23b}] run scoreboard players set #selected map 21
execute unless data block 43 31 -12 Items[{Slot:17b}] run scoreboard players set #selected map 20
...
execute if score #selected map > flag.map.end_fandom const run scoreboard players set #selected map -2
