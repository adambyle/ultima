...
execute if score @s round matches 0 store result score #time _var run data get storage ult:temp GlobalData.Half.Time
execute if score @s round matches 1 store result score #time _var run data get storage ult:temp GlobalData.Full.Time
...
execute if score @s round matches 0 run data modify storage ult:temp RecordHolder set from storage ult:temp GlobalData.Half.Name
execute if score @s round matches 1 run data modify storage ult:temp RecordHolder set from storage ult:temp GlobalData.Full.Name
...
execute if score @s round matches 0 store result storage ult:temp GlobalData.Half.Time int 1.0 run scoreboard players get @s timer
execute if score @s round matches 0 run data modify storage ult:temp GlobalData.Half.Name set from block 0 0 0 Items[0].tag.display.Name
execute if score @s round matches 0 run data modify storage ult:temp GlobalData.Half.UUID set from entity @s UUID
...
execute if score @s round matches 1 store result storage ult:temp GlobalData.Full.Time int 1.0 run scoreboard players get @s timer
execute if score @s round matches 1 run data modify storage ult:temp GlobalData.Full.Name set from block 0 0 0 Items[0].tag.display.Name
execute if score @s round matches 1 run data modify storage ult:temp GlobalData.Full.UUID set from entity @s UUID
