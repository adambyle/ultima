...
execute if score @s parkour matches 2 run data modify storage ult:temp GlobalData set from storage ult:players Global.Parkour.woodlands
execute if score @s parkour matches 2 run data modify storage ult:temp PlayerData set from storage ult:temp Player.Parkour.woodlands

execute store result score #wr _var run data get storage ult:temp GlobalData.Half.Time
execute if score @s timer <= #wr _var run function ult:parkour/world_record
execute store result score #pb _var run data get storage ult:temp PlayerData.Half
...
execute if score @s timer > #wr _var if score @s timer >= #pb _var run tellraw @s [{"text": "You finished the first half in "}, {"storage": "ult:temp", "nbt": "Time", "color": "gray", "interpret": true}]
...
execute if score @s parkour matches 2 run data modify storage ult:players Global.Parkour.woodlands set from storage ult:temp GlobalData
execute if score @s parkour matches 2 run data modify storage ult:temp Player.Parkour.woodlands set from storage ult:temp PlayerData
