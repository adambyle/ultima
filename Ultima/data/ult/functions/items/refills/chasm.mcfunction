...
clear @s ender_pearl
execute store result score .hotbar var run data get storage ult:temp Player.Hotbar.chasm.pearl
loot replace block 0 0 0 container.0 loot ult:map_items/chasm/soul_stone
function ult:items/give
