...
# Announce the results
    ...
    execute if score .temp_map _var = .map flag run tellraw @a[tag=chat.n.e] [{"text": "N: ", "color": "dark_gray"}, [{"storage": "ult:temp", "nbt": "Map", "color": "#43AA8B"}, ": ", [{"score": {"name": ".count", "objective": "_var"}, "underlined": true, "hoverEvent": {"action": "show_text", "contents": [{"storage": "ult:temp", "nbt": "Voters", "interpret": true, "color": "white"}, {"text": " voted for ", "color": "gray"}, {"storage": "ult:temp", "nbt": "Map", "color": "gray", "italic": true}]}}, " votes"]]]
    # If this was not the chosen map...
    execute unless score .temp_map _var = .map flag run tellraw @a[tag=chat.n.e] [{"text": "N: ", "color": "dark_gray"}, [{"storage": "ult:temp", "nbt": "Map", "color": "dark_gray"}, ": ", [{"score": {"name": ".count", "objective": "_var"}, "underlined": true, "hoverEvent": {"action": "show_text", "contents": [{"storage": "ult:temp", "nbt": "Voters", "interpret": true, "color": "white"}, {"text": " voted for ", "color": "gray"}, {"storage": "ult:temp", "nbt": "Map", "color": "gray", "italic": true}]}}, " votes"]]]
    # ..map 2
