...
execute if score #flag game_state matches 1 if score #server map matches 19 run function ult:tick/active/map/hill
execute if score #flag game_state matches 1 if score #server map matches 20 run function ult:tick/active/map/bathhouse
