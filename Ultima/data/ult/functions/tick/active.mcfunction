...
# Map specific functions
    execute if score .map flag = flag.map.woodlands const run function ult:tick/maps/woodlands
    execute if score .map flag = flag.map.dungeon const run function ult:tick/maps/dungeon
    execute if score .map flag = flag.map.abyss const run function ult:tick/maps/abyss
    execute if score .map flag = flag.map.citadel const run function ult:tick/maps/citadel
    execute if score .map flag = flag.map.wasteland const run function ult:tick/maps/wasteland
    execute if score .map flag = flag.map.town_square const run function ult:tick/maps/town_square
    execute if score .map flag = flag.map.last_stand const run function ult:tick/maps/last_stand
    execute if score .map flag = flag.map.permafrost const run function ult:tick/maps/permafrost
    execute if score .map flag = flag.map.shroom const run function ult:tick/maps/shroom
    execute if score .map flag = flag.map.hellscape const run function ult:tick/maps/hellscape
    execute if score .map flag = flag.map.frontier const run function ult:tick/maps/frontier
    execute if score .map flag = flag.map.reflection const run function ult:tick/maps/reflection
    execute if score .map flag = flag.map.dracula const run function ult:tick/maps/dracula
    execute if score .map flag = flag.map.avanto const run function ult:tick/maps/avanto
    execute if score .map flag = flag.map.boxing const run function ult:tick/maps/boxing
    execute if score .map flag = flag.map.ancient const run function ult:tick/maps/ancient
    execute if score .map flag = flag.map.marooned const run function ult:tick/maps/marooned

# Mode specific functions
    execute if score .game_mode flag = flag.game_mode.royale const run function ult:tick/modes/royale
    execute if score .game_mode flag = flag.game_mode.brawl const run function ult:tick/modes/brawl
