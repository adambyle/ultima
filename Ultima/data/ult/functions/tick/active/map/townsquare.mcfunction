...
loot give @a[scores={x.damage=1..}] loot ult:map_items/town_square/emerald

execute as @a[scores={x.crouch=1}, nbt={SelectedItem: {id: "minecraft:netherite_ingot"}}] run function ult:tick/active/map/town_square/upgrade_armor
