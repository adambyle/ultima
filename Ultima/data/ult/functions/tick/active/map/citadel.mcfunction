execute as @a[tag=player, tag=alive, nbt=!{Inventory: [{id: "minecraft:ender_pearl"}]}] run function ult:event/citadel/pearl
...
execute if score #map event matches 0 run function ult:event/citadel/summon_rune

execute as @a[scores={x.crouch=1}, tag=player, tag=alive, nbt={SelectedItem: {id: "minecraft:globe_banner_pattern"}}] run function ult:event/citadel/activate_rune
execute as @a[scores={x.crouch=1}, tag=player, tag=alive, nbt={Inventory: [{id: "minecraft:globe_banner_pattern", Slot: -106b}]}] run function ult:event/citadel/activate_rune
...
execute as @a[nbt={SelectedItem: {id: "minecraft:crossbow"}, Inventory: [{id: "minecraft:arrow"}]}, nbt=!{SelectedItem: {tag: {Charged: true}}}] run function ult:event/citadel/refill_arrow
