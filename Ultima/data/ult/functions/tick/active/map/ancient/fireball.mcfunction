...
summon fireball ^ ^ ^1 {ExplosionPower: 0, Tags: ["temp_fireball"]}
...
execute store result score #z _var run data get entity @e[tag=temp, limit=1] Pos[2] 1000000

execute store result score #x2 _var run data get entity @e[tag=temp_fireball, limit=1] Pos[0] 1000000
execute store result score #y2 _var run data get entity @e[tag=temp_fireball, limit=1] Pos[1] 1000000
execute store result score #z2 _var run data get entity @e[tag=temp_fireball, limit=1] Pos[2] 1000000
...
data modify entity @e[tag=temp_fireball, limit=1] Motion set from storage ult:temp Motion
data modify entity @e[tag=temp_fireball, limit=1] power set from storage ult:temp Power
