...
execute if score #upgrade _var matches 1 run function ult:tick/active/map/ancient/upgrade/axe
execute if score #upgrade _var matches 2 run function ult:tick/active/map/ancient/upgrade/pickaxe
execute if score #upgrade _var matches 3 run function ult:tick/active/map/ancient/upgrade/hoe
execute if score #upgrade _var matches 4 run function ult:tick/active/map/ancient/upgrade/chestplate
execute if score #upgrade _var matches 5 run function ult:tick/active/map/ancient/upgrade/leggings
execute if score #upgrade _var matches 6 run function ult:tick/active/map/ancient/upgrade/helmet
execute if score #upgrade _var matches 7 run function ult:tick/active/map/ancient/upgrade/boots
