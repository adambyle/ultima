execute as @a[tag=player, tag=alive, nbt=!{Inventory: [{id: "minecraft:firework_rocket"}]}] run function ult:tick/active/map/reflection/rocket
...
execute as @e[type=firework_rocket, tag=!reflection_rocket] at @s run function ult:tick/active/map/reflection/reflect
