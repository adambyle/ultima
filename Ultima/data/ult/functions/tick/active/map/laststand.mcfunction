execute as @a[scores={x.crouch=1}, nbt={SelectedItem: {id: "minecraft:coal"}}] at @s anchored eyes run function ult:tick/active/map/last_stand/fireball
...
execute as @a[tag=player, tag=alive, scores={x.crouch=1}] at @s at @e[tag=last_stand_skill, distance=..3] if block ~ ~-1 ~ lectern unless score @s event.skill = @e[tag=last_stand_skill, sort=nearest, limit=1] event.skill run function ult:tick/active/map/last_stand/skill/apply
...
execute as @a[tag=player, tag=alive, scores={x.damage=0.., event.skill=1}] at @s run function ult:tick/active/map/last_stand/flurry/flurry
execute as @a[tag=player, tag=alive, scores={event=0, event.skill=3}] run function ult:tick/active/map/last_stand/combo/remove
execute as @a[tag=player, tag=alive, scores={x.damage=0.., event.skill=3}] run function ult:tick/active/map/last_stand/combo/apply
