execute as @a[tag=player, tag=alive] run function ult:tick/maps/marooned/trident_ownership
...
execute if score .map event matches 100 run function ult:tick/maps/marooned/flood/0
execute if score .map event matches 110 run function ult:tick/maps/marooned/flood/1
execute if score .map event matches 120 run function ult:tick/maps/marooned/flood/2
execute if score .map event matches 130 run function ult:tick/maps/marooned/flood/3
execute if score .map event matches 140 run function ult:tick/maps/marooned/flood/4
execute if score .map event matches 150 run function ult:tick/maps/marooned/flood/5
execute if score .map event matches 160 run function ult:tick/maps/marooned/flood/6
execute if score .map event matches 170 run function ult:tick/maps/marooned/flood/7

execute if score .map event matches 300 run function ult:tick/maps/marooned/unflood/7
execute if score .map event matches 310 run function ult:tick/maps/marooned/unflood/6
execute if score .map event matches 320 run function ult:tick/maps/marooned/unflood/5
execute if score .map event matches 330 run function ult:tick/maps/marooned/unflood/4
execute if score .map event matches 340 run function ult:tick/maps/marooned/unflood/3
execute if score .map event matches 350 run function ult:tick/maps/marooned/unflood/2
execute if score .map event matches 360 run function ult:tick/maps/marooned/unflood/1
execute if score .map event matches 370 run function ult:tick/maps/marooned/unflood/0
...
execute as @a[scores={event.salmon=1..}, nbt=!{Inventory: [{id: "minecraft:cooked_salmon"}]}] run function ult:tick/maps/marooned/food

execute as @a[scores={crouch_mode=1}, nbt={SelectedItem: {id: "minecraft:cooked_salmon"}}] run function ult:tick/maps/marooned/eat_food
execute as @a[scores={crouch_mode=1}, nbt={Inventory: [{id: "minecraft:cooked_salmon", Slot: -106b}]}] run function ult:tick/maps/marooned/eat_food
