execute as @a[tag=player, tag=alive, nbt=!{Inventory: [{id: "minecraft:ender_pearl"}]}] run function ult:tick/maps/citadel/pearl
...
execute if score .map event matches 0 run function ult:tick/maps/citadel/summon_rune

execute as @a[tag=player, tag=alive, scores={crouch_mode=1}, nbt={SelectedItem: {id: "minecraft:globe_banner_pattern"}}] run function ult:tick/maps/citadel/activate_rune
execute as @a[tag=player, tag=alive, scores={crouch_mode=1}, nbt={Inventory: [{id: "minecraft:globe_banner_pattern", Slot: -106b}]}] run function ult:tick/maps/citadel/activate_rune
...
execute as @a[nbt={SelectedItem: {id: "minecraft:crossbow"}, Inventory: [{id: "minecraft:arrow"}]}, nbt=!{SelectedItem: {tag: {Charged: true}}}] run function ult:tick/maps/citadel/refill_arrow
