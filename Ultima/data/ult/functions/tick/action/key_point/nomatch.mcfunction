...
execute if data storage ult:temp Key.playReflection run tellraw @s "The Reflection map has two halves that you can travel by crouching or jumping. You have unlimited firework rockets to kill other players, and you are more speedy while holding the crossbow. Fireworks are also reflected across the glass border, so you can shoot players on the other side if you aim in the opposite direction."
