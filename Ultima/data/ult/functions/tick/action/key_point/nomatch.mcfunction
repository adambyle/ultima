...
execute if data storage ult:temp Key.playHill run tellraw @s [{"text": "Key point! ", "color": "gold", "bold": true}, {"text": "Fighting for King of the Hill", "color": "yellow", "bold": false}, "\n"]
execute if data storage ult:temp Key.playBathhouse run tellraw @s [{"text": "Key point! ", "color": "gold", "bold": true}, {"text": "Playing the Bathhouse map", "color": "yellow", "bold": false}, "\n"]
...
execute if data storage ult:temp Key.playHill run tellraw @s "The Hill has been left without a ruler! Get to the center of the map in time for Beatdown Phase to pummel your friends."
execute if data storage ult:temp Key.playBathhouse run tellraw @s "The Bathhouse map features a series of floating platforms looming over a pool of bath water. Be careful, the water is so comforting, you may end up too relaxed!"
