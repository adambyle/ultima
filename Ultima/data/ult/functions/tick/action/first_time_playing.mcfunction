...
tellraw @s [{"text": "For a more in-depth explanation of the way Ultima works, check out the Wiki on ", "color": "gray"}, {"text": "GitHub.", "underlined": true, "clickEvent": {"action": "open_url", "value": "https://github.com/beegyfleeg/ultimabr/wiki"}}]
