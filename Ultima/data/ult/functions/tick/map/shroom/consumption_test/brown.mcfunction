...
# If can enchant
    ...
    execute if score .enchant var matches 1 run function ult:tick/map/shroom/upgrade/sword

# Otherwise
    execute if score .enchant var matches 0 at @s run playsound entity.player.burp master @s ~ ~ ~ 4
    execute if score .enchant var matches 0 run clear @s brown_mushroom 1
