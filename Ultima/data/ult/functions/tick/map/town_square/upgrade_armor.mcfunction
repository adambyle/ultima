...
# Upgrade
    execute if score .armor _var matches 1 run function ult:tick/map/town_square/upgrade_armor/boots
    execute if score .armor _var matches 2 run function ult:tick/map/town_square/upgrade_armor/helmet
    execute if score .armor _var matches 3 run function ult:tick/map/town_square/upgrade_armor/leggings
