...
execute store result score .diamonds _var run clear @s diamond 0
...
execute if score .diamonds _var matches 3 run function ult:tick/map/permafrost/diamond_boots
execute if score .diamonds _var matches ..2 unless data entity @s Inventory[{Slot: 100b}] run function ult:items/give
