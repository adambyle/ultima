...
execute if score randmap q matches -1 run function uub:settings/vote/tally
...
execute if score mode q matches 2 if score randmap q matches -1 run scoreboard players set invalid n 7
...
execute if score invalid n matches 7 run tellraw @a [{"text": "Can't start! ","color": "dark_red"},{"text": "Map voting is not compatible with Duels mode.","color": "gray"}]
...
execute if score invalid n matches 0 run function uub:settings/main_menu
...
execute if score invalid n matches 0 if score map q matches 1..12 run title @a subtitle {"text": "By Adam Byle","color": "gold"}
execute if score invalid n matches 0 if score map q matches 13 run title @a subtitle {"text": "By Jonathan Deiss","color": "gold"}
execute if score invalid n matches 0 if score map q matches 14 run title @a subtitle {"text": "By Reed Aldridge","color": "gold"}
execute if score invalid n matches 0 if score map q matches 15 run title @a subtitle {"text": "By Tucker Lawson","color": "gold"}
execute if score invalid n matches 0 unless score randmap q matches 0 run function uub:settings/announce_map
