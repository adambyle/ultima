...
execute unless entity @s[team=spect] if score @s action matches 6 run title @s actionbar {"text": "You cannot opt in right now.","color": "red"}
...
execute if score game q matches 1.. if score @s action matches 6 run function uub:tick/action/opt
