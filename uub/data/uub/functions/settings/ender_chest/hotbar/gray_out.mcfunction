...
execute if score #server map matches 1 store result score #temp _var run clear @s #uub:map_items/manor 0
execute if score #server map matches 2 store result score #temp _var run clear @s #uub:map_items/woodlands 0
execute if score #server map matches 3 store result score #temp _var run clear @s #uub:map_items/dungeon 0
...
execute if score #temp _var matches 1 run function uub:settings/ender_chest/hotbar
