...
execute if score mode q matches 5 run scoreboard players set mode q 1
...
execute if score mode q matches 4 run data modify entity @e[tag=gsw,limit=1] CustomName set value '{"text":"Double Elimination","color":"aqua","italic":true}'
