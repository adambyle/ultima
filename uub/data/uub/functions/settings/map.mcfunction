...
execute if score map q matches 4 run scoreboard players set map q 0
...
execute if score map q matches 1..3 run data modify entity @e[tag=msw,limit=1] CustomName set value '{"text":"by Adam Byle","color":"light_purple"}'
