...
execute if score map q matches 4 run scoreboard players set map q 1
...
execute if score map q matches 2 run data modify entity @e[tag=mnm,limit=1] CustomName set value '{"text":"Dungeon [Coming soon]","color":"dark_purple"}'
execute if score map q matches 3 run data modify entity @e[tag=mnm,limit=1] CustomName set value '{"text":"Woodlands [Coming soon]","color":"dark_purple"}'
