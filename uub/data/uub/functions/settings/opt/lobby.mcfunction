...
execute unless score #debug game_state matches 1 if score #flag game_mode = #boss game_mode unless score #server pn matches 2.. run function uub:settings/opt/end_early
gamemode adventure
tp @s 45 30 -12
