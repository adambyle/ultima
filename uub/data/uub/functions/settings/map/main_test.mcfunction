execute unless data block 43 31 -12 Items[{id:"minecraft:paper"}] run scoreboard players operation #flag map = #vote map
...
execute if score #temp _var matches 1 run function uub:settings/map/main/changed_map
