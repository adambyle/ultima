...
tellraw @a [{"selector": "@a[tag=alive]"},{"text": " was at ","color": "gray"},{"score": {"name": "@r[tag=alive]","objective": "hp"},"color": "dark_red"},{"text": " HP.","color": "gray"}]
title @s times 5 30 5
scoreboard players set game q 3
title @s title {"text": "Respawning...","color": "red"}
schedule function uub:event/duels 2s
