...
execute if score #server map matches 11 run function uub:spawn/items/lost/hell
execute if score #server map matches 12 run function uub:spawn/items/lost/frontier
execute if score #server map matches 13 run function uub:spawn/items/lost/reflection
execute if score #server map matches 14 run function uub:spawn/items/lost/dracula
execute if score #server map matches 15 run function uub:spawn/items/lost/avanto
execute if score #server map matches 16 run function uub:spawn/items/lost/boxing
