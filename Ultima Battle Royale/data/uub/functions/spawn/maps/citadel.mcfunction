...
replaceitem entity @s armor.legs golden_leggings{Unbreakable:1b, Enchantments: [{id: "projectile_protection", lvl: 2}]}
replaceitem entity @s armor.chest golden_chestplate{Unbreakable:1b, Enchantments: [{id: "projectile_protection", lvl: 2}]}
