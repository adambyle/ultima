...
execute as @e[tag=chest.ring] run function uub:chest/infer
execute as @e[tag=chest.center] run function uub:chest/infer

execute as @e[tag=!chest.ring, tag=!chest.center, tag=!chest.spawn, tag=chest] unless score @s chest_type = #empty chest_type at @s unless entity @a[tag=player, tag=alive, distance=..12] run function uub:chest/random
execute as @e[tag=!chest.ring, tag=!chest.center, tag=!chest.spawn, tag=chest] if score @s chest_type = #empty chest_type run function uub:chest/random
