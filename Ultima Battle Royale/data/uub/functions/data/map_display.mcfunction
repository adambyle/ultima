...
data modify block 45 35 -23 Text1 set value '{"storage":"uub:temp","nbt":"Map","color":"gold","italic":true}'
...
data modify block 45 35 -23 Text1 set value '[{"text":"By ","color":"dark_aqua","italic":true},{"storage":"uub:temp","nbt":"Author"}]'
