...
scoreboard objectives add z.dungeon.axe dummy
scoreboard objectives add z.dungeon.speed dummy
scoreboard objectives add z.dungeon.sneak dummy
scoreboard objectives add z.dungeon.harm dummy
scoreboard objectives add z.dungeon.shield dummy

scoreboard objectives add z.abyss.sword dummy
scoreboard objectives add z.abyss.arrows dummy
...
scoreboard objectives add z.citadel.bow dummy
scoreboard objectives add z.citadel.arrows dummy
scoreboard objectives add z.citadel.shield dummy
scoreboard objectives add z.citadel.pearls dummy

scoreboard objectives add z.reflect.sword dummy
scoreboard objectives add z.reflect.bow dummy
scoreboard objectives add z.reflect.arrows dummy
scoreboard objectives add z.reflect.pearls dummy

scoreboard objectives add z.dracula.sword dummy
scoreboard objectives add z.dracula.bow dummy
