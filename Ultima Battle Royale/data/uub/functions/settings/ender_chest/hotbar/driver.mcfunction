...
execute if score @s hotbar_map matches ..12 if score @s hotbar_map > #max_default map run function uub:settings/ender_chest/hotbar
execute if score @s hotbar_map matches 13.. if score @s hotbar_map > #max_fandom map run function uub:settings/ender_chest/hotbar
