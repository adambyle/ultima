...
replaceitem entity @s enderchest.22 ender_eye{display: {Name: '{"text": "Spectator Settings", "bold": true, "color": "dark_aqua", "italic": false}', Lore: ['[{"text": "Control when the game makes you a spectator. ", "color": "gray"}, {"text": "(Coming soon)", "color": "white"}]']}}
