...
execute if score #temp _var matches 1.. if score @s ready matches 0 run function uub:start/ready
execute if score #temp _var matches 1.. if score @s ready matches 1 run tellraw @a [{"selector": "@s", "color": "gray"}, " changed their vote."]
execute if score #temp _var matches 1.. if score @s ready matches 1 run function uub:tp/lobby
