...
execute as @a[tag=player, tag=alive, nbt=!{ActiveEffects: [{Id: 14b}]}] if score @s pn = @r[tag=root] tether at @s run particle angry_villager ~ ~3 ~ 0.2 0.2 0.2 0 1 normal @a[tag=root]
