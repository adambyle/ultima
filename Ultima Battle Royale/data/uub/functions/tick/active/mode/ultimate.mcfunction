...
execute as @e[tag=chest, scores={chest_type=1..}] at @s unless data block ~ ~ ~ LootTable unless entity @a[tag=player, tag=alive, distance=..6] run function uub:chest/empty
